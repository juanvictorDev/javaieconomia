...
public class Carne implements Produto{
  private String id;
  private String nome;
  private String tipo;
  ...
  private float peso;
  private Setor local;
  public static String classe = "Carne";

  public Carne(String id, String nome, String tipo, double preco, float peso, Setor local){
    this.id = id;
    this.nome = nome;
    this.tipo = tipo;
    this.preco = preco;
