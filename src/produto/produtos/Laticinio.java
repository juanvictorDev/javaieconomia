...
public class Laticinio implements Produto{
  private String id;
  private String nome;
  private String tipo;
  ...
  public Laticinio(String id, String nome, String tipo, double preco, String medida, Setor local){
    this.id = id;
    this.nome = nome;
    this.tipo = tipo;
    this.preco = preco;
