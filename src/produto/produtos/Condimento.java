...
public class Condimento implements Produto{
  private String id;
  private String nome;
  private String tipo;
  ...
  public Condimento(String id, String nome, String tipo, double preco, float peso, Setor local){
    this.id = id;
    this.nome = nome;
    this.tipo = tipo;
    this.preco = preco;
